...
import { BinaryWriter } from '../../src/debug-protocol/binaryIO';
import { VariableFlags, VariableType, VariableRequestFlags } from '../../src/debug-protocol/constants';
...
const { DebugCommands } = require('../../src/debug-protocol/commands');
