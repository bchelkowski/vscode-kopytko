...
export const SG_NODES: Record<string, SgNodeDefinition> = {
  ...
  Label: {
    ...
    fields: [
      ...
      { name: 'truncateOnDelimiter', type: 'string', description: 'Character at which to truncate text (adds ellipsis).' },
    ],
    methods: [],
  },
  ...
  BusySpinner: {
    ...
    fields: [
      { name: 'uri', type: 'uri', description: 'URI of the spinner spritesheet image.' },
  ...
  RowList: {
    ...
    docsUrl: 'https://developer.roku.com/docs/references/scenegraph/node-classes/rowlist.md',
    fields: [
      { name: 'itemComponentName', type: 'string', description: 'Default item component name for all rows.' },
      { name: 'animateToRow', type: 'integer', description: 'Write a row index to animate to that row.' },
