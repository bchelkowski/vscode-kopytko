...
import { StoredDevice, computeNetworkId } from 'kopytko-roku-device';
...
export class DeviceStore {
   ...
   * network interfaces. Delegates to kopytko-roku-device's
   * `computeNetworkId` — kept as a static for existing callers.
   */
