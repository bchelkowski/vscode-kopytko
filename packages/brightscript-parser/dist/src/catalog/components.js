...
exports.CATALOG_LAST_VERIFIED = exports.BRIGHTSCRIPT_COMPONENTS = exports.BRIGHTSCRIPT_INTERFACES = void 0;
exports.findComponent = findComponent;
exports.findInterface = findInterface;
exports.getComponentMethods = getComponentMethods;
exports.findMethodInterface = findMethodInterface;
// ---------------------------------------------------------------------------
// Interface definitions
// ---------------------------------------------------------------------------
exports.BRIGHTSCRIPT_INTERFACES = {
    // ── ifArray ──────────────────────────────────────────────────────────────
    ifArray: {
        name: 'ifArray',
    ...
    ifEnum: {
        ...
        methods: [
            ...
            { name: 'Each', signature: 'Each() as Dynamic', returnType: 'Dynamic', description: 'Returns each element in sequence, suitable for use in for-each.' },
        ],
    },
    // ── ifAssociativeArray ───────────────────────────────────────────────────
    ifAssociativeArray: {
        ...
        methods: [
            ...
            { name: 'Values', signature: 'Values() as Object', returnType: 'roArray', description: 'Returns an roArray of all values.' },
    ...
    ifString: {
        ...
        methods: [
            ...
            { name: 'ToStr', signature: 'ToStr() as String', returnType: 'String', description: 'Returns the string representation.' },
        ],
    },
    // ── ifStringOps ──────────────────────────────────────────────────────────
    ifStringOps: {
        ...
        methods: [
            ...
            { name: 'InstrRev', signature: 'InstrRev(substring as String) as Integer', returnType: 'Integer', description: 'Returns the 1-based position of the last occurrence of substring. Returns 0 if not found.' },
            ...
            { name: 'ToUpper', signature: 'ToUpper() as String', returnType: 'String', description: 'Returns the string converted to uppercase.' },
            { name: 'ToLower', signature: 'ToLower() as String', returnType: 'String', description: 'Returns the string converted to lowercase.' },
            ...
            { name: 'GetEntityDecode', signature: 'GetEntityDecode() as String', returnType: 'String', description: 'Returns the string with HTML entities decoded.' },
    ...
    ifList: {
        ...
        methods: [
            ...
            { name: 'IsEmpty', signature: 'IsEmpty() as Boolean', returnType: 'Boolean', description: 'Returns true if the list has no elements.' },
    ...
    ifXMLElement: {
        ...
        methods: [
            ...
            { name: 'GetChildCount', signature: 'GetChildCount() as Integer', returnType: 'Integer', description: 'Returns the number of child elements.' },
            { name: 'GetChild', signature: 'GetChild(index as Integer) as Object', returnType: 'roXMLElement', description: 'Returns the child element at index.' },
            { name: 'GetChildByName', signature: 'GetChildByName(name as String) as Object', returnType: 'roXMLElement', description: 'Returns the first child element with the given tag name.' },
            { name: 'GetChildrenByName', signature: 'GetChildrenByName(name as String) as Object', returnType: 'roXMLList', description: 'Returns all child elements with the given tag name.' },
            { name: 'AddChild', signature: 'AddChild(child as Object) as Void', returnType: 'Void', description: 'Appends a child roXMLElement.' },
            { name: 'RemoveChild', signature: 'RemoveChild(child as Object) as Boolean', returnType: 'Boolean', description: 'Removes the given child element. Returns true if found.' },
    ...
    ifXMLList: {
        ...
        methods: [
            ...
            { name: 'GetBody', signature: 'GetBody() as Dynamic', returnType: 'Dynamic', description: 'Returns body of the first element.' },
            ...
            { name: 'GetName', signature: 'GetName() as String', returnType: 'String', description: 'Returns the tag name of the first element.' },
            { name: 'GetText', signature: 'GetText() as String', returnType: 'String', description: 'Returns text content of the first element.' },
            { name: 'Count', signature: 'Count() as Integer', returnType: 'Integer', description: 'Returns the number of elements in the list.' },
    ...
    ifDateTime: {
        ...
        methods: [
            ...
            { name: 'GetDayOfYear', signature: 'GetDayOfYear() as Integer', returnType: 'Integer', description: 'Returns day of year (1–366).' },
    ...
    ifUrlTransfer: {
        ...
        methods: [
            ...
            { name: 'SetHeaders', signature: 'SetHeaders(headers as Object) as Boolean', returnType: 'Boolean', description: 'Replaces all request headers with the given AssociativeArray.' },
            { name: 'AddHeader', signature: 'AddHeader(name as String, value as String) as Boolean', returnType: 'Boolean', description: 'Adds a single request header.' },
            { name: 'GetResponseCode', signature: 'GetResponseCode() as Integer', returnType: 'Integer', description: 'Returns the HTTP response status code from the last synchronous request.' },
            { name: 'GetResponseHeaders', signature: 'GetResponseHeaders() as Object', returnType: 'roAssociativeArray', description: 'Returns response headers as an AssociativeArray (last value wins for duplicates).' },
            { name: 'GetResponseHeadersArray', signature: 'GetResponseHeadersArray() as Object', returnType: 'roArray', description: 'Returns all response headers as an array of AssociativeArrays (preserves duplicates).' },
            ...
            { name: 'InitClientCertificates', signature: 'InitClientCertificates() as Boolean', returnType: 'Boolean', description: 'Loads device client certificates for mutual TLS authentication.' },
            ...
            { name: 'SetCertificatesFile', signature: 'SetCertificatesFile(path as String) as Boolean', returnType: 'Boolean', description: 'Loads CA certificates from the given PEM file.' },
            { name: 'EnableCookies', signature: 'EnableCookies() as Void', returnType: 'Void', description: 'Enables the cookie engine for this transfer object.' },
            { name: 'GetCookies', signature: 'GetCookies(domain as String, path as String) as Object', returnType: 'roArray', description: 'Returns cookies matching domain and path.' },
    ...
    ifFileSystem: {
        ...
        methods: [
            ...
            { name: 'MoveFile', signature: 'MoveFile(source as String, destination as String) as Boolean', returnType: 'Boolean', description: 'Moves/renames a file. Returns true on success.' },
            ...
            { name: 'GetFreeSpace', signature: 'GetFreeSpace(path as String) as Double', returnType: 'Double', description: 'Returns free space in bytes for the volume containing path.' },
    ...
    ifPath: {
        ...
        methods: [
            ...
            { name: 'GetPath', signature: 'GetPath() as String', returnType: 'String', description: 'Returns the full path string.' },
            { name: 'GetParentPath', signature: 'GetParentPath() as String', returnType: 'String', description: 'Returns the parent directory path.' },
            { name: 'GetFilename', signature: 'GetFilename() as String', returnType: 'String', description: 'Returns the filename including extension.' },
            { name: 'GetBasename', signature: 'GetBasename() as String', returnType: 'String', description: 'Returns the filename without extension.' },
            { name: 'GetExtension', signature: 'GetExtension() as String', returnType: 'String', description: 'Returns the file extension including the dot (e.g. ".brs").' },
        ],
    },
    // ── ifDeviceInfo ─────────────────────────────────────────────────────────
    ifDeviceInfo: {
        ...
        methods: [
            ...
            { name: 'GetFirmwareVersion', signature: 'GetFirmwareVersion() as Object', returnType: 'roAssociativeArray', description: 'Returns AA with keys "major", "minor", "revision", "build".' },
            ...
            { name: 'GetMemoryLevel', signature: 'GetMemoryLevel() as String', returnType: 'String', description: 'Returns device memory pressure: "normal", "low", "critical".' },
            ...
            { name: 'GetHDMIStatus', signature: 'GetHDMIStatus() as Object', returnType: 'roAssociativeArray', description: 'Returns HDMI connection status details.' },
            { name: 'GetTimeSinceLastKeypress', signature: 'GetTimeSinceLastKeypress() as Integer', returnType: 'Integer', description: 'Returns seconds since the last remote keypress.' },
    ...
    ifAppInfo: {
        ...
        methods: [
            ...
            { name: 'GetSubtitle', signature: 'GetSubtitle() as String', returnType: 'String', description: 'Returns the channel subtitle from the manifest.' },
    ...
    ifAudioPlayer: {
        ...
        methods: [
            ...
            { name: 'Next', signature: 'Next() as Boolean', returnType: 'Boolean', description: 'Skips to the next item in the content list.' },
            ...
            { name: 'GetPlaybackDuration', signature: 'GetPlaybackDuration() as Integer', returnType: 'Integer', description: 'Returns the total duration of the current item in seconds.' },
            { name: 'GetPlayheadPosition', signature: 'GetPlayheadPosition() as Integer', returnType: 'Integer', description: 'Returns the current playhead position in seconds.' },
        ],
    },
    // ── ifEVPDigest ──────────────────────────────────────────────────────────
    ifEVPDigest: {
    ...
    ifChannelStore: {
        ...
        methods: [
            ...
            { name: 'GetPurchaseList', signature: 'GetPurchaseList() as Void', returnType: 'Void', description: 'Requests the user\'s purchase history for this channel. Result arrives as roChannelStoreEvent.' },
...
// ---------------------------------------------------------------------------
exports.BRIGHTSCRIPT_COMPONENTS = [
    {
        name: 'roArray',
    ...
    },
    {
        ...
        interfaces: ['ifUrlTransfer', 'ifSetMessagePort', 'ifGetMessagePort'],
    },
    {
        name: 'roMessagePort',
...
const _componentMap = new Map(exports.BRIGHTSCRIPT_COMPONENTS.map((c) => [c.name.toLowerCase(), c]));
/** Map keyed by interface name (lowercase) for O(1) lookups. */
const _interfaceMap = new Map(Object.entries(exports.BRIGHTSCRIPT_INTERFACES).map(([k, v]) => [k.toLowerCase(), v]));
...
const _methodIfaceCache = new Map();
/**
 * Returns the name of the interface that defines methodName on componentName,
 * or undefined if not found.
 */
function findMethodInterface(componentName, methodName) {
    const cacheKey = `${componentName.toLowerCase()}|${methodName.toLowerCase()}`;
    if (_methodIfaceCache.has(cacheKey))
        return _methodIfaceCache.get(cacheKey);
    const component = findComponent(componentName);
    if (!component) {
    ...
    for (const ifName of component.interfaces) {
        ...
        if (found) {
            _methodIfaceCache.set(cacheKey, iface);
            return iface;
        }
    }
    _methodIfaceCache.set(cacheKey, undefined);
 ...
 */
exports.CATALOG_LAST_VERIFIED = '2026-06-04';
