...
exports.NUMERIC_LITERAL_GLOBAL_RE = void 0;
exports.inferNumericLiteralType = inferNumericLiteralType;
exports.isNumericLiteral = isNumericLiteral;
exports.stripNumericLiterals = stripNumericLiterals;
/**
 ...
 */
const NUMERIC_LITERAL_RE = /^-?(?:(&[Hh][0-9A-Fa-f]+)(&)?|(\d+\.?\d*|\d*\.\d+)(?:[Ee][+-]?\d+|[Dd][+-]?\d+)?[%!#&]?)$/;
/**
 ...
 */
function stripNumericLiterals(line) {
    return line.replace(exports.NUMERIC_LITERAL_GLOBAL_RE, (match) => '0'.repeat(match.length));
}
