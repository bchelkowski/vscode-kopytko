/* eslint-disable @typescript-eslint/no-unused-vars */import { SyntaxNode, TriviaKind, isToken, isNode } from 'brightscript-parser';
import type { Token, Trivia } from 'brightscript-parser';
