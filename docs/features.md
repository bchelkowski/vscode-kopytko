...
| Tools sidebar — quick-nav buttons, top to bottom: Device Manager, Diagnostics, Network Inspector, Deep Linking, SceneGraph Tree, Perfetto, Roku Pay Web Services | ✅ | [diagnostics.md](./diagnostics.md) |
