...
Multi-pass engine (17 CST passes + text passes, 49 configurable options), shared by the editor and the `kopytko-format` CLI. Full settings: [formatting.md](./formatting.md).
